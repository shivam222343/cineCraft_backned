-- Quick fix for database schema - Run this in your PostgreSQL database
-- This will fix the "column price does not exist" error
...
-- Step 2: Add missing columns to services table
...
-- Step 3: Remove old column if it exists
...
-- Step 5: Remove old portfolio columns
ALTER TABLE portfolio 
DROP COLUMN IF EXISTS tags,
DROP COLUMN IF EXISTS media_url;

-- Step 6: Clear and insert correct data
DELETE FROM bookings;
DELETE FROM portfolio;
DELETE FROM services;

-- Step 7: Insert services with correct structure
...
-- Step 11: Show table structure to confirm
\d services;
\d portfolio;
