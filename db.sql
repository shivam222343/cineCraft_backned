-- CineCraft Media PostgreSQL schema and seed data
...
-- Grant permissions on sequences (fix for permission denied errors)
...
-- Services (must be inserted before bookings due to foreign key)
...
-- Sample bookings (inserted after services)
