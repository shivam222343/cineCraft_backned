-- CineCraft Media - Add Sample Data and Admin User (Fixed Version)
-- This script adds 2-3 sample entries to each table and creates an admin user

-- =============================================
-- ADD ADMIN USER WITH SPECIFIED EMAIL (Check if exists first)
-- =============================================
...
-- =============================================
-- ADD ADDITIONAL BOOKINGS (Use existing user IDs)
-- =============================================
...
-- =============================================
-- ADD ADDITIONAL PORTFOLIO EVENTS (if tables exist)
-- =============================================
DO $$
BEGIN
